...
<aside id="secondary"
	class="sidebar bg-white w-64 py-8 px-4 space-y-4 shadow-md absolute inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out"
